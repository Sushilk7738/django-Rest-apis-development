...
# class EmpInfo(mixins.ListModelMixin, mixins.CreateModelMixin,generics.GenericAPIView):
...
class EmpInfo(generics.ListCreateAPIView ,generics.GenericAPIView):
    queryset = Employee.objects.all()
    serializer_class = EmployeeSerializer

class EmpDetails(generics.RetrieveUpdateDestroyAPIView ,generics.GenericAPIView):
    queryset = Employee.objects.all()
    serializer_class = EmployeeSerializer
    lookup_field = "pk"
