...
# class Player(mixins.ListModelMixin, mixins.CreateModelMixin,generics.GenericAPIView):
...
# class PlayerDetails(mixins.RetrieveModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin ,generics.GenericAPIView):
#     queryset = Players.objects.all()
#     serializer_class = PlayerSerializer
